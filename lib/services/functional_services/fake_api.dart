  ...
  Future<List<Expenditure>> getAllExpenditures() async {
    ...
    return [
      ...
      Expenditure(
          ...
          moneyAmount: 69.76,
          name: "Weekly Groceries",
          date: DateTime(2020, 08, 2)),
      Expenditure(
          id: 29,
          categoryId: 5,
          moneyAmount: 19.99,
          name: "Pizza with friends",
          date: DateTime(2020, 08, 4)),
      Expenditure(
          id: 30,
          categoryId: 10,
          moneyAmount: 29.99,
      ...
      Expenditure(
          ...
          moneyAmount: 99.99,
          name: "Gym membership",
          date: DateTime(2020, 08, 5)),
      Expenditure(
          id: 36,
          categoryId: 7,
          moneyAmount: 10.99,
          name: "Cinema",
          date: DateTime(2020, 08, 6)),
      Expenditure(
          id: 37,
          categoryId: 5,
          moneyAmount: 11.60,
      ...
      Expenditure(
          ...
          moneyAmount: 43.67,
          name: "Groceries",
          date: DateTime(2020, 08, 7)),
      Expenditure(
          id: 39,
          categoryId: 13,
          moneyAmount: 11.88,
          name: "Uber",
          date: DateTime(2020, 08, 8)),
    ];
  }
