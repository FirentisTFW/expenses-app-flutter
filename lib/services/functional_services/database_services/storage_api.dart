...
class StorageApi extends Api {
  ...
  Future<List<Expenditure>> getAllExpenditures() async {
    try {
      final expendituresResults = await _databaseService.database.rawQuery(
  ...
  Future<List<TotalMonthlyExpenses>> getTotalMonthlyExpensesInTimeSpan(
    ...
    try {
      ...
      final monthlyExpensesResults = await _databaseService.database.rawQuery(
  ...
  Future<List<TotalCategoryExpenses>> getTotalCategoryExpensesInTimeSpan(
    ...
    try {
      ...
      final categoryExpensesResults = await _databaseService.database.rawQuery(
